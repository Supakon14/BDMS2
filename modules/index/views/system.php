...
class View extends \Gcms\View
{
    ...
    public function render($config, $login)
    {
        ...
        $fieldset->add('select', [
            ...
            'options' => [1 => '{LNG_Can login}', 0 => '{LNG_Can&#039;t login} ({LNG_Waiting to check from the staff})'],
        ...
        $fieldset->add('select', [
            ...
            'itemClass' => 'item',
            'label' => '{LNG_Accept member verification request}',
        ...
        if ($department != '') {
            ...
            $fieldset->add('select', [
                ...
                'itemClass' => 'item',
                'label' => $department,
                'comment' => Language::replace(':name for new members Used when members need to specify', [':name' => $department]),
                'options' => ['' => '{LNG_Not specified}'] + $category->toSelect('department'),
